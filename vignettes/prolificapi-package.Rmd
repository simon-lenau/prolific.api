...
The output shows that the study has been assigned an `id` (`"63c685b069efa4c6740894ae"` in this case).
...
#> 1:   2023-01-17      11:25:36              
#>                             name                       id study_type
#> 1: <Publicly visible study name> 63c685b069efa4c6740894ae     SINGLE
...
`"studies/63c685b069efa4c6740894ae"`:
...
```r
# Obtain the study with ID 63c685b069efa4c6740894ae from Prolific
obtained_study <- 
	prolific_api_access$access(
		endpoint = c("studies","63c685b069efa4c6740894ae"),
		method = "get"
)
```
...
**A full searchable list of all currently available prescreeners (as of 2023-01-17)
...
The following table contains **all 290**  currently (as of 2023-01-17) available prescreeners.
