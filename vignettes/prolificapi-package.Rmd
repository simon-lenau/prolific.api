...
![Preview of the Prolific Study](Study_Preview.jpg){width=100%}  
...
For example, the age requirement of `new_study_with_prescreeners` can be relaxed to allow for
...
``` {r, reactable_list_fields_methods, eval = TRUE, include = TRUE, echo=FALSE}
```
