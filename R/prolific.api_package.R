...
#' \href{https://www.prolific.co/}{Prolific} platform via its \href{https://docs.prolific.co/docs/api-docs/public/}{API}.
...
#' characterize the participants to be selected for a certain \code{\link[=prolific_study]{study}},
...
#' Once you chose the correct workspace \href{https://www.prolific.co/}{\code{Prolific web UI}}, the tokens can be managed in the \code{Settings -> Go to API token page} menu.
#'
NULL
